...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            if (params.lableTo) {
                this.lableTo = document.querySelector(params.lableTo);
            }
        ...
        finish: function(e) {
          ...
          //  _self.trigger.value = provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):(''));
            ...
            if (this.nameTo) {
                this.nameTo.value = provinceText + ((cityText) ? (',' + cityText) : ('')) + ((countyText) ? (',' + countyText) : (''));
            }

            if (this.lableTo) {
                this.lableTo.innerHTML = provinceText + ((cityText) ? (',' + cityText) : ('')) + ((countyText) ? (',' + countyText) : (''));
            }
